/* ═══════════════════════════════════════════════════════════════════
   ...
   Manages the full game lifecycle:
     1. render(container, gameId, title) — build DOM, start game, connect SSE
...
const GameView = (function () {
     ...
     *  Renders a single green-text option (same color as story title)
    ...
    function _showFatalError(message) {
        Display.showErrorModal(
            ...
            /* Retry: re-render */
            () => {
                render(_container, _gameId, _title);
            },
            /* Exit */
            () => {
