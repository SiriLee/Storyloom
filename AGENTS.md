...
**Status (2026-08-14):** Phase 2 complete. Web interface (FastAPI + SSE). Launcher-based auto-update. Packaging: standalone binary (PyInstaller) + pip wheel. i18n: backend gettext + frontend i18next. Version 2.3.0.
...
- **Data-driven:** static metadata lives in data files (e.g. `lang_meta/{lang}.json`) — adding data must not require code changes
